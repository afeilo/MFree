...
package com.xiefei.openmusicplayer.database;
    ...
    public ArrayList<MusicPlaybackTrack> getQueue() {
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                do {
                    results.add(new MusicPlaybackTrack( cursor.getLong(0),
                            OpenMusicPlayerUtils.IdType.getTypeById(cursor.getInt(1)), cursor.getInt(2)));
