...
//    public long mSourceId;
    public OpenMusicPlayerUtils.IdType mSourceType;
    public int mSourcePosition;

    public MusicPlaybackTrack(long id, OpenMusicPlayerUtils.IdType type, int sourcePosition) {
        mId = id;
//        mSourceId = sourceId;
        mSourceType = type;
...
//        mSourceId = in.readLong();
        mSourceType = OpenMusicPlayerUtils.IdType.getTypeById(in.readInt());
